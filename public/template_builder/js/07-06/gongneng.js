...
BuFen = {
    MainModules: {
        "Main Modules": ["headerbanner_1s", "headerbanner_2s", "headerbanner_3s","service_1s","who_we_are_1s","testimonial_1s","strat_project","price_1s","management"]
    }
},
RQz = ["MainModules"],
        RQm = [".BGtable-inner"],
