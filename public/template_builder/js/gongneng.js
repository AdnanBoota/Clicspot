...
var isDemo = false,
    ...
    Itm = {
        ...
        who_we_are_2s: "who_we_are_2s",
        process: "process",
        full_img_1s: "full_img_1s",
        divider: "divider",
        from_blog_2s: "from_blog_2s",
        products: "products",
        from_blog_3s: "from_blog_3s",
        testimonial_2s: "testimonial_2s",
        price_2s: "price_2s",
        service_2s: "service_2s",
        who_we_are_3s: "who_we_are_3s",
        timeline: "timeline",
        projects: "projects",
        full_img_2s: "full_img_2s",
        from_blog_4s: "from_blog_4s",
        testimonial_3s: "testimonial_3s",
        price_3s: "price_3s",
        partner: "partner",
        bottom: "bottom",
        footer: "footer"
