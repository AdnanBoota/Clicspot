...
<section class="content editrouterblock">
    ...
    <form class="editrouterform">
        <div class="editformblock">
            {!!  Form::text('shortname', null, array('id'=>'shortname','class'=>'lcname','required'=>'true','placeholder'=>'Location Name','required'=>'true')) !!}
             {!!  Form::text('ssid', null, array('id'=>'shortname','class'=>'wifinnm','required'=>'true','placeholder'=>'Wireless Name','required'=>'true')) !!}
