...
<!--                {{  App::getLocale() }} -->
                ...
                <select name="locale" id="countries">
						...
						<option value='ae' {{  (App::getLocale()=='ae') ? 'selected' : '' }} data-image="{{ asset('/cntry/images/msdropdown/icons/blank.gif') }}" data-imagecss="flag ae" data-title="United Arab Emirates">United Arab Emirates</option>
