                    ...
                    <div class="col-md-7">
                        <div class="reviewblockdetail">
                            <div class="reviewtitle">
                                ...
                                <h2>{{ Lang::get('emails.review') }}</h2>
                            </div>
                            <p>{{ Lang::get('emails.selectrouter') }}</p>
                            <div class="selectbox">
                            ...
                            <div class="urlreviewblock ">
                                ...
                                <p class="successnote">{{ Lang::get('emails.urlisvalid') }}</p>
                                <p class="errornote">{{ Lang::get('emails.errornote') }}</p>
                            </div>
                            <p>{{ Lang::get('emails.chooseperiod') }}</p>
                            <div class=""><input id="range_5" type="text" name="range_5" data-from=""></div>
                            <p>{{ Lang::get('emails.chooseemail') }}</p>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="box box-danger">
                            <div class="box-header with-border">
                                <h3 class="box-title">{{ Lang::get('emails.statisticreport') }}</h3>
                            ...
                            <div class="box-body" id="transactionalReport">
                                <div id="message" style="width: 100%; text-align:center"></div>
                ...
                <div class="row">
                    <div class="reviewtabdetial">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#Standard" aria-controls="Standard" role="tab" data-toggle="tab">{{ Lang::get('emails.standard') }}</a></li>
                            <li role="presentation"><a href="offertab" aria-controls="offertab" role="tab" data-toggle="tab">{{ Lang::get('emails.10off') }}</a></li>
                        </ul>
...
//                   $("#range_5").data("from",o);
        ...
        $("#socialmedia").blur(function(){
            ...
            if(pattern.test(urlval)){
                if(urlval.indexOf("tripadvisor")!=-1 || urlval.indexOf("facebook")!=-1 || urlval.indexOf("google")!=-1 || urlval.indexOf("yelp")!=-1 || urlval.indexOf("zoover")!=-1){
                    ...
                    else if(urlval.indexOf("zoover.nl")!=-1){
                        $("#trip").removeClass('active');
                        $("#yoff").removeClass('active');
                        $("#gplus").removeClass('active');
                        $("#fb").removeClass('active');
...
//        alert("hello");
    ...
    function transactionalReport(){
        var selectedRouter = $("#router").val();

        $.ajax({
            url: "/emails/transactionals/report/",
            method: 'GET',
            data: {
            ...
            success: function (PieData) {
                ...
                if(PieData.length > 0 && PieData[0]["value"] > 0 && PieData[1]["value"] > 0 && PieData[2]["value"] > 0 ) {
                    $("#transactionalReport #message").html("");
                    pieChart.Doughnut(PieData, pieOptions);
                }else{
                    $("#transactionalReport #message").html("No data to show");
                    pieChart.Doughnut({}, pieOptions);
                }
