            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!!  Form::text('subject', null, array('id'=>'subject','class'=>'form-control','required'=>'true')) !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {!! Form::label('msgBody', 'Message', array('class' => 'col-sm-2 control-label')) !!}
                        <div class="col-xs-12 col-md-8" contenteditable="true" id="contentEditor">
                        ...
                        {!!  Form::hidden('msgBody', null, array('id'=>'msgBody','class'=>'form-control')) !!}
                ...
                <div class="box-footer">
                    ...
                    <a href="{{url('emails')}}" class="btn btn-default">Cancel</a>
