...
<!-- Main content -->
<section class="content camp_page">
    <div class="row">
        <div class="col-md-3 lefControls">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#center" aria-controls="profile" role="tab" data-toggle="tab">center</a></li>
            </ul>
        ...
        <div class="col-md-9">
                ...
                <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header headerlogodrop">
                            <a class="navbar-brand" href="javascript:void(0)">
                                ...
                                @else
                                <img src="{{ asset("/img/Clicspot-Grey.png") }}" alt="logo" style="margin-top:-2px;margin-left: 28px;max-height: 40px;max-width: 120px;"/>
                                @endif
                            </a>
            ...
            <div class="imageslider">
                                ...
                                <div class="item active">
                                    <div class="row-fluid">
                                        @forelse($images as $key=>$image)
                                          ...
                                          @endif
                                        <div class="span3"><a href="javascript:void(0);" class="thumbnail"><img src="{{ $image }}" height="100" width="100" alt="..." class="margin" style="height:100px;width:100px;" /></a></div>
                                        @empty
                                        <div class="span3"><a href="javascript:void(0);" class="thumbnail"><img src="/img/captive-wallpaper.jpg" height="100" width="100" alt="..." class="margin" style="height:100px;width:100px;" /></a></div>
                                        @endforelse
                                    </div><!--/row-fluid-->
                                </div>
                            </div><!--/carousel-inner-->
                ...
                <div class="col-md-3">
                    <div class="imgaddrgt">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#gallaryModal"><i class="addimg"></i></a>
                    </div>
                </div>        
            </div>
