...
<section class="statistics-box">
    <div class="row">
        <div class="statistics">
            <i class="fa fa-fw  fa-list-alt"></i><span>{{ Lang::get('auth.bdd') }}</span>
                    ...
                    <li>
                        <a href="">
                         ...
                         <div class="selectlistblock expList">
                             <a href="javascript:void(0);" val='csv' style="font-size: 14px">{{ Lang::get('auth.downloadcsv') }}</a>
                             <a href="javascript:void(0);" val='xls' >{{ Lang::get('auth.downloadxls') }}</a>
                             <a href="javascript:void(0);" val='txt' >{{ Lang::get('auth.downloadtxt') }}</a>
                        </div>
                    </li>
                </ul>
            </div>
